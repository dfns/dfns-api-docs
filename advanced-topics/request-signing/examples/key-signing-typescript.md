...
import { makeDfnsApiRequest } from './makeDfnsApiRequest'
import { AssetAccount, ClientData, UserActionSignatureChallenge } from './types'
...
export const createAssetAccount = async () => {
  ...
  // origin should match the origin set in the Application that matches AppId in makeDfnsApiRequest.ts
  const origin = 'REPLACE_ME'
...
{% endcode %}
{% endtab %}
{% tab title="makeDfnsApiRequest.ts" %}
{% code title="makeDfnsApiRequest.ts" overflow="wrap" lineNumbers="true" %}
```typescript
import { IncomingMessage } from 'http'
import * as https from 'https'

import { SignChallenge, SignedChallenge, UserActionSignatureChallenge, WithRequired } from './types'
