...
If you are using [Postman](https://www.postman.com/), you can start out forking our Postman collection:
...
The purpose of the pre-request script is to populate some of the [required headers](request-headers.md) for authentication. If you're interested in what it does and how it works, you can check the detail of the pre-request script in the collection itself.
