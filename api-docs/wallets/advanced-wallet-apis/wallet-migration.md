...
<table data-full-width="false"><thead><tr><th width="200">Property</th><th width="203">Type - Required/Optional</th><th>Description</th></tr></thead><tbody><tr><td>network</td><td>String - Required</td><td>Network enum for the wallet (See <a href="../#supported-networks">Supported Networks</a> +  <a href="../#pseudo-networks">Pseudo Network</a> for possible values)</td></tr><tr><td>name</td><td>String - Required</td><td>A name for the wallet</td></tr><tr><td>protocol</td><td>String - Required</td><td>Always <code>CGGMP21</code> (only protocol supported for import currently)</td></tr><tr><td>curve</td><td>String - Required</td><td>Always <code>secp256k1</code> (only curve supported for import currently)</td></tr><tr><td>minSigners</td><td>Integer - Required</td><td>Always <code>3</code>. Min number of signers to complete a signature (TSS threshold).</td></tr><tr><td>encryptedKeyShares</td><td>Object Array - Required</td><td>An array of objects containing the encrypted keyshares.  See format below. </td></tr></tbody></table>
