...
| ---------------------- | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------- |
| `to`                   | Optional                     | Representation of Cardano address of recipient.                                                                                                                                                                                                                                                                                                  | String                                    |
...
| `rewardAddress`                   | Optional                     | Representation of Cardano address of recipient.                                                                                                                                                                                                                                                                                                  | String                                    |
| `poolId`                   | Optional                     | Representation of Cardano address of recipient.                                                                                                                                                                                                                                                                                                  | String                                    |
| `script`                   | Optional                     | Representation of Cardano address of recipient.                                                                                                                                                                                                                                                                                                  | Script                                    |
| `redeemer`                   | Optional                     | Representation of Cardano address of recipient.                                                                                                                                                                                                                                                                                                  | Redeemer                                    |
| `superSecret`                   | Optional                     | Representation of Cardano address of recipient.                                                                                                                                                                                                                                                                                                  | String                                    |
| `pool`                   | Optional                     | Representation of Cardano address of recipient.                                                                                                                                                                                                                                                                                                  | Pool                                    |
...
| Request body fields    | Required/Optional            | Description                                                                                                                                                                                                                                                                                                                                      | Type                                      |
| ---------------------- | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------- |
| `unit`                   | Required                     | App ID of box to be accessed.                                                                                                                                                                                                                                                                                                  | String                                    |
| `quantity`                   | Required                     | Name of box to be accessed.                                                                                                                                                                                                                                                                                                    | String                                    |
...
| Request body fields    | Required/Optional            | Description                                                                                                                                                                                                                                                                                                                                      | Type                                      |
| ---------------------- | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------- |
| `assetName`                   | Required                     | App ID of box to be accessed.                                                                                                                                                                                                                                                                                                  | String                                    |
| `assetQuantity`                   | Required                     | Name of box to be accessed.                                                                                                                                                                                                                                                                                                    | String                                    |
| `metadata`                   | Required                     | Name of box to be accessed.                                                                                                                                                                                                                                                                                                    | MintAssetMetadata                                    |
| `label`                   | Required                     | Name of box to be accessed.                                                                                                                                                                                                                                                                                                    | String                                    |
| `recipient`                   | Required                     | Name of box to be accessed.                                                                                                                                                                                                                                                                                                    | String                                    |
