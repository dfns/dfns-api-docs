...
| `programId`                   | Required                     | Program Id to execute.                                                                                                                                                                                                                                                                                                  | String                                    |
| `data`                   | Optional                     | Program input. Encoded hex string.                                                                                                                                                                                                                                                                                                  | String                                    |
...
| Request body fields    | Required/Optional            | Description                                                                                                                                                                                                                                                                                                                                      | Type                                      |
| ---------------------- | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------- |
| `pubkey`                   | Required                     |An account's public key. Encoded hex string..                                                                                                                                                                                                                                                                                                  | String                                    |
...
| `publicKey`                   | Required                     | Encoded hex string.                                                                                                                                                                                                                                                                                                  | String                                    |
