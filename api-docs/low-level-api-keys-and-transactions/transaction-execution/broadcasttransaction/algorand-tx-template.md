...
| `defaultFrozen`                   | Required on creation                     | True to freeze holdings for this asset by default.                                                                                                                                                                                                                                                                                                  | String                                    |
...
| `freezeState`                   | Optional                     | true if freezeTarget should be frozen, false if freezeTarget should be allowed to transact.                                                                                                                                                                                                                                                                                                  | String                                    |
