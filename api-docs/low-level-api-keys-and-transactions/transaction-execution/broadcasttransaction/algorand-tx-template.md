...
| `voteKey`                   | Optional                     | The root participation public key. For key deregistration, leave empty or not send. See Generate a Participation Key [here](https://developer.algorand.org/docs/run-a-node/participate/generate_keys/).                                                                                                                                                                                                                                                                                                  | String                                    |
| `selectionKey`                   | Optional                     | The VRF public key. For key deregistration, leave empty or not send.                                                                                                                                                                                                                                                                                                  | String                                    |
| `stateProofKey`                   | Optional                     | The 64 byte state proof public key commitment. For key deregistration, leave empty or not send.                                                                                                                                                                                                                                                                                                  | String                                    |
| `voteFirst`                   | Optional                     | The first round that the participation key is valid. Not to be confused with the FirstValid round of the keyreg transaction..                                                                                                                                                                                                                                                                                                  | String                                    |
| `voteLast`                   | Optional                     | The last round that the participation key is valid. Not to be confused with the LastValid round of the keyreg transaction.                                                                                                                                                                                                                                                                                                  | String                                    |
