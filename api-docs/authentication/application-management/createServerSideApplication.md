...
Creates a server side application in the caller's organization

### Required Permissions <a href="#scopes" id="scopes"></a>

TODO

### User Action Signature Request Body (ServerSide Application) <a href="#user-action-signature" id="user-action-signature"></a>

```json
{
  "userActionPayload": "{\"appName\":\"<NAME>\",\"scopes\":[<SCOPES>],\"permissions\":[<PERMISSIONS>],\"kind\":\"Application\",\"expectedRpId\":\"<RELYING_PARTY_ID>\",\"expectedOrigin\":\"<ORIGIN>\",\"appKind\":\"ServerSideApplication\",\"publicKey\":\"<PEM_ENCODED_PUBLIC_KEY>\"}",
