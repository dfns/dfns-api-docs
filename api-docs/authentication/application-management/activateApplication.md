...
{% code title="activateApplication.ts" overflow="wrap" lineNumbers="true" %}
```typescript
...
{% code title="activateApplication.js" overflow="wrap" lineNumbers="true" %}
```javascript
import { httpClient } from './dfnsHttpClient'
import { generateUserActionSignature } from './generateUserActionSignature'
...
curl -X PUT "/auth/apps/ap-4s6se-e2t7n-89gfg50iaos73pm6/activate" \
