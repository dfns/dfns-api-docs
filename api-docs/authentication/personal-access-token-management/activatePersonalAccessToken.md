...
{% embed url="https://github.com/dfnsext/dfns-api-docs/blob/canary/examples/typescript/src/api/authentication/personal-access-token-management/activate-personal-access-token.ts" %} Typescript Example {% endembed %}
