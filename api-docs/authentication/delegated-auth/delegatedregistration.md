...
If you want to use your own authentication system, while still using `Delegated Signing`, you can use this endpoint to register a User in your organization, without your user needing receive an email from Dfns.
...
| `kind` <mark style="color:red;">\*</mark> | `String` | kind of user being created. Can be one of the following:<br />`EndUser`<br />`CustomerEmployee` |
