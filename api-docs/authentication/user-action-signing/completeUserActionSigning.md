...
| `credentialAssertion.clientData` <mark style="color:red;">\*</mark> | `String` | base64url encoded [Client Data](../../../advanced-topics/authentication/request-signing.md#client-data-format) JSON string object that was signed with the user's private key |
