...
* [Authentication](api-docs/authentication.md)
  * [Login](api-docs/authentication/login/README.md)
    ...
    * [Create User Login](api-docs/authentication/login/completeLogin.md)
  * [Registration](api-docs/authentication/registration/README.md)
    ...
    * [Create User Registration](api-docs/authentication/registration/completeUserRegistration.md)
  ...
  * [User Management](api-docs/authentication/user-management/README.md)
    * [ActivateUser](api-docs/authentication/user-management/activateUser.md)
    * [DeactivateUser](api-docs/authentication/user-management/deactivateUser.md)
    * [CreateUser](api-docs/authentication/user-management/createUser.md)
    * [ResendRegistrationEmail](api-docs/authentication/user-management/resendRegistrationEmail.md)
    * [ListUsers](api-docs/authentication/user-management/listUsers.md)
  * [Application Management](api-docs/authentication/application-management/README.md)
    * [ActivateApplication](api-docs/authentication/application-management/activateApplication.md)
    * [DeactivateApplication](api-docs/authentication/application-management/deactivateApplication.md)
    * [CreateApplication](api-docs/authentication/application-management/createApplication.md)
    * [ListApplications](api-docs/authentication/application-management/listApplications.md)
  * [Credential Management](api-docs/authentication/credential-management/README.md)
    * [CreateUserCredentialChallenge](api-docs/authentication/credential-management/createUserCredentialChallenge.md)
    * [CreateUserCredential](api-docs/authentication/credential-management/createUserCredential.md)
    * [ActivateCredential](api-docs/authentication/credential-management/activateCredential.md)
    * [DeactivateCredential](api-docs/authentication/credential-management/deactivateCredential.md)
    * [ListUserCredentials](api-docs/authentication/credential-management/listUserCredentials.md)
  * [DelegatedLogin](api-docs/authentication/delegatedLogin.md)
  * [DelegatedRegistration](api-docs/authentication/delegatedRegistration.md)
