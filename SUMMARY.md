...
* [Deprecated APIs](api-docs/deprecated-apis/README.md)
  * [Deprecated - Employees](api-docs/deprecated-apis/employees/README.md)
    * [Employees Overview](api-docs/deprecated-apis/employees/employees-overview.md)
    * [Get Employee By ID](api-docs/deprecated-apis/employees/getpermissionbyid.md)
    * [List Employees](api-docs/deprecated-apis/employees/listpermissions.md)
  * [Deprecated - ApiKeys](api-docs/deprecated-apis/apikeys/README.md)
    * [ApiKeys Overview](api-docs/deprecated-apis/apikeys/api-keys.md)
    * [Create API Key](api-docs/deprecated-apis/apikeys/createapikey.md)
    * [Get API Key By ID](api-docs/deprecated-apis/apikeys/getapikeybyid.md)
    * [List API Keys](api-docs/deprecated-apis/apikeys/listapikeys.md)
    * [Revoke API Key](api-docs/deprecated-apis/apikeys/revokeapikey.md)
