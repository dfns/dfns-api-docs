...
* [Exchanges](api-docs/exchanges/README.md)
  * [Exchange Configuration](api-docs/exchanges/exchange-configuration/README.md)
    * [Kraken Setup](api-docs/exchanges/exchange-configuration/kraken-setup.md)
  * [API Reference](api-docs/exchanges/api-reference/README.md)
    * [Create Exchange](api-docs/exchanges/api-reference/create-exchange.md)
    * [List Exchanges](api-docs/exchanges/api-reference/list-exchanges.md)
    * [Get Exchange](api-docs/exchanges/api-reference/get-exchange.md)
    * [Delete Exchange](api-docs/exchanges/api-reference/delete-exchange.md)
    * [List Exchange Accounts](api-docs/exchanges/api-reference/list-exchange-accounts.md)
    * [List Exchange Account Assets](api-docs/exchanges/api-reference/list-exchange-account-assets.md)
    * [Create Exchange Deposit](api-docs/exchanges/api-reference/create-exchange-deposit.md)
    * [Create Exchange Withdrawal](api-docs/exchanges/api-reference/create-exchange-withdrawal.md)
